...
class TC_GAME_API Object
{
    public:
        ...
        void SetDynamicFlag(uint32 flag) {
            SetFlag(UF::OBJECT_DYNAMIC_FLAGS, flag);
            SetUpdateFieldFlagValue(m_values.ModifyValue(&Object::m_objectData).ModifyValue(&UF::ObjectData::DynamicFlags), flag);
        }
        void RemoveDynamicFlag(uint32 flag) {
            RemoveFlag(UF::OBJECT_DYNAMIC_FLAGS, flag);
            RemoveUpdateFieldFlagValue(m_values.ModifyValue(&Object::m_objectData).ModifyValue(&UF::ObjectData::DynamicFlags), flag);
        }
        void ReplaceAllDynamicFlags(uint32 flag) {
            SetUInt32Value(UF::OBJECT_DYNAMIC_FLAGS, flag);
            SetUpdateFieldValue(m_values.ModifyValue(&Object::m_objectData).ModifyValue(&UF::ObjectData::DynamicFlags), flag);
        }
