...
enum OpcodeClient : uint16
{
    ...
    CMSG_DISCARDED_TIME_SYNC_ACKS = 0x3A3F,
    ...
    CMSG_TIME_ADJUSTMENT_RESPONSE = 0x3A3E,
    CMSG_TIME_SYNC_RESPONSE = 0x3A3B,
    CMSG_TIME_SYNC_RESPONSE_DROPPED = 0x3A3D,
    CMSG_TIME_SYNC_RESPONSE_FAILED = 0x3A3C,
    ...
    CMSG_UPDATE_MISSILE_TRAJECTORY = 0x3A41,
    ...
    //TODOFROST - check what happend to these opcodes:
    CMSG_CHANGE_SUB_GROUP = 0xBADD,
    CMSG_MASTER_LOOT_ITEM = 0xBADD,
    CMSG_MOVE_SET_FACING_HEARTBEAT = 0xBADD,
    CMSG_OVERRIDE_SCREEN_FLASH = 0xBADD,
    CMSG_QUERY_GARRISON_PET_NAME = 0xBADD,
    CMSG_QUERY_PLAYER_NAMES = 0xBADD,
    CMSG_SWAP_SUB_GROUPS = 0xBADD,
    CMSG_TUTORIAL = 0xBADD,
    CMSG_SEND_CONTACT_LIST = 0xBADD,

    //TODOFROST - check opcodes which used to be deleted, but what included with hermes changes
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ADVENTURE_JOURNAL_DATA_RESPONSE = 0x2886,
    ...
    SMSG_APPLY_MOUNT_EQUIPMENT_RESULT = 0x2862,
    SMSG_ARCHAEOLOGY_SURVERY_CAST = 0x2588,
    SMSG_AREA_POI_UPDATE_RESPONSE = 0x3011,
    SMSG_AREA_SPIRIT_HEALER_TIME = 0x2736,
    ...
    SMSG_ARENA_TEAM_COMMAND_RESULT = 0x2759,
    SMSG_ARENA_TEAM_EVENT = 0x2758,
    SMSG_ARENA_TEAM_INVITE = 0x2757,
    SMSG_ARENA_TEAM_ROSTER = 0x2756,
    SMSG_ARENA_TEAM_STATS = 0x275A,
    ...
    SMSG_AUCTION_LIST_PENDING_SALES_RESULT = 0x26EB,
    ...
    SMSG_BROADCAST_SUMMON_CAST = 0x2855,
    SMSG_BROADCAST_SUMMON_RESPONSE = 0x2856,
    ...
    SMSG_CAMERA_EFFECT = 0x271C,
    SMSG_CANCEL_AUTO_REPEAT = 0x26D5,
    ...
    SMSG_CHAR_CUSTOMIZE_FAILURE = 0x26D9,
    SMSG_CHAR_CUSTOMIZE_SUCCESS = 0x26DA,
    ...
    SMSG_CLAIM_RAF_REWARD_RESPONSE = 0x2866,
    ...
    SMSG_CLOSE_HEART_FORGE = 0x2821,
    SMSG_CLUB_FINDER_ERROR_MESSAGE = 0x285E,
    SMSG_CLUB_FINDER_GET_CLUB_POSTING_IDS_RESPONSE = 0x2861,
    SMSG_CLUB_FINDER_LOOKUP_CLUB_POSTINGS_LIST = 0x285F,
    SMSG_CLUB_FINDER_RESPONSE_CHARACTER_APPLICATION_LIST = 0x285C,
    SMSG_CLUB_FINDER_RESPONSE_POST_RECRUITMENT_MESSAGE = 0x2860,
    SMSG_CLUB_FINDER_UPDATE_APPLICATIONS = 0x285D,
    ...
    SMSG_COOLDOWN_CHEAT = 0x272F,
    SMSG_COOLDOWN_EVENT = 0x26B1,
    SMSG_CORPSE_LOCATION = 0x2647,
    SMSG_CORPSE_RECLAIM_DELAY = 0x2740,
    ...
    SMSG_COVENANT_RENOWN_OPEN_NPC = 0x2888,
    SMSG_CREATE_CHAR = 0x26F7,
    SMSG_CREATE_SHIPMENT_RESPONSE = 0x2794,
    SMSG_CRITERIA_DELETED = 0x26DE,
    SMSG_CRITERIA_UPDATE = 0x26D8,
    ...
    SMSG_DURABILITY_DAMAGE_DEATH = 0x273C,
    SMSG_EMOTE = 0x27C1,
    ...
    SMSG_EXPLORATION_EXPERIENCE = 0x2755,
    SMSG_EXTERNAL_TRANSACTION_ID_GENERATED = 0x2887,
    SMSG_FACTION_BONUS_INFO = 0x271B,
    ...
    SMSG_GAME_OBJECT_UI_LINK = 0x2710,
    ...
    SMSG_INITIALIZE_FACTIONS = 0x271A,
    SMSG_INITIAL_SETUP = 0x2580,
    SMSG_INIT_WORLD_STATES = 0x273D,
    SMSG_INSPECT_HONOR_STATS = 0x2932,
    SMSG_INSPECT_PVP = 0x2718,
    ...
    SMSG_INVALID_PROMOTION_CODE = 0x2749,
    ...
    SMSG_ISLAND_AZERITE_GAIN = 0x2752,
    SMSG_ISLAND_COMPLETE = 0x2753,
    SMSG_IS_QUEST_COMPLETE_RESPONSE = 0x2A84,
    SMSG_ITEM_CHANGED = 0x26E1,
    SMSG_ITEM_COOLDOWN = 0x27BF,
    SMSG_ITEM_ENCHANT_TIME_UPDATE = 0x274B,
    ...
    SMSG_ITEM_TIME_UPDATE = 0x274A,
    SMSG_KICK_REASON = 0x2681,
    SMSG_LATENCY_REPORT_PING = 0x2892,
    ...
    SMSG_LOG_XP_GAIN = 0x26DC,
    SMSG_LOOT_ALL_PASSED = 0x261A,
    SMSG_LOOT_LIST = 0x2737,
    ...
    SMSG_MAIL_LIST_RESULT = 0x274C,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT = 0x274D,
    ...
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA = 0x26DD,
    SMSG_ON_MONSTER_MOVE = 0x2DD4,
    SMSG_OPEN_ANIMA_DIVERSION_UI = 0x2711,
    SMSG_OPEN_CONTAINER = 0x2DA6,
    SMSG_OPEN_HEART_FORGE = 0x2820,
    SMSG_OPEN_LFG_DUNGEON_FINDER = 0x2A31,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP = 0x2791,
    ...
    SMSG_PARTY_KILL_LOG = 0x2750,
    SMSG_PARTY_MEMBER_FULL_STATE = 0x274F,
    SMSG_PARTY_MEMBER_PARTIAL_STATE = 0x274E,
    ...
    SMSG_PETITION_SIGN_RESULTS = 0x2742,
    SMSG_PET_ACTION_FEEDBACK = 0x273F,
    ...
    SMSG_PLAY_ONE_SHOT_ANIM_KIT = 0x2727,
    ...
    SMSG_QUERY_TIME_RESPONSE = 0x26DB,
    ...
    SMSG_RAF_ACCOUNT_INFO = 0x2865,
    SMSG_RAF_ACTIVITY_STATE_CHANGED = 0x2876,
    ...
    SMSG_REATTACH_RESURRECT = 0x2741,
    ...
    SMSG_RETURN_APPLICANT_LIST = 0x285B,
    SMSG_RETURN_RECRUITING_CLUBS = 0x285A,
    ...
    SMSG_SET_AI_ANIM_KIT = 0x2726,
    SMSG_SET_ALL_TASK_PROGRESS = 0x2788,
    SMSG_SET_ANIM_TIER = 0x272A,
    ...
    SMSG_SET_FACTION_NOT_VISIBLE = 0x2721,
    SMSG_SET_FACTION_STANDING = 0x2722,
    SMSG_SET_FACTION_VISIBLE = 0x2720,
    ...
    SMSG_SET_MELEE_ANIM_KIT = 0x2729,
    SMSG_SET_MOVEMENT_ANIM_KIT = 0x2728,
    ...
    SMSG_SOCKET_GEMS_FAILURE = 0x271E,
    SMSG_SOCKET_GEMS_SUCCESS = 0x271D,
    ...
    SMSG_SPIRIT_HEALER_CONFIRM = 0x270B,
    ...
    SMSG_TOTEM_DURATION_CHANGED = 0x26D4,
    SMSG_TOTEM_MOVED = 0x26C1,
    SMSG_TRADE_STATUS = 0x2582,
    SMSG_TRADE_UPDATED = 0x2581,
    SMSG_TRAINER_BUY_FAILED = 0x26D7,
    SMSG_TRAINER_LIST = 0x26D6,
    ...
    SMSG_TURN_IN_PETITION_RESULT = 0x2744,
    SMSG_TUTORIAL_FLAGS = 0x27B5,
    SMSG_TWITTER_STATUS = 0x3043,
    SMSG_UI_HEALING_RANGE_MODIFIED = 0x273A,
    ...
    SMSG_UPDATE_AADC_STATUS_RESPONSE = 0x2894,
    ...
    SMSG_QUERY_PLAYER_NAMES_RESPONSE = 0xBADD,
...
/*    SMSG_MULTI_FLOOR_LEAVE_FLOOR                                = 0xBADD,
    SMSG_MULTI_FLOOR_NEW_FLOOR                                  = 0xBAD*/D,
