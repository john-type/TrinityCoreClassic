...
enum OpcodeClient : uint16
{
    ...
    CMSG_AUCTION_BROWSE_QUERY = 0x34CD, // formerly CMSG_AUCTION_LIST_ITEMS
    ...
    CMSG_TOY_CLEAR_FANFARE = 0xBADD,
    CMSG_BATTLE_PAY_DISTRIBUTION_ASSIGN_VAS = 0xBADD,
    CMSG_ACCOUNT_NOTIFICATION_ACKNOWLEDGED = 0xBADD,
    CMSG_MOUNT_CLEAR_FANFARE = 0xBADD,
    CMSG_MOVE_APPLY_INERTIA_ACK = 0xBADD,
    CMSG_SET_CHAT_DISABLED = 0xBADD,
    ...
    CMSG_MOVE_REMOVE_INERTIA_ACK = 0xBADD,
    CMSG_MOVE_INERTIA_ENABLE_ACK = 0xBADD,
    CMSG_MOVE_INERTIA_DISABLE_ACK = 0xBADD,
    CMSG_LATENCY_REPORT = 0xBADD,
    CMSG_GUILD_QUERY_RECIPES = 0xBADD,
    CMSG_GUILD_QUERY_MEMBER_RECIPES = 0xBADD,
    CMSG_GET_ACCOUNT_NOTIFICATIONS = 0xBADD,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_MOVE_DISABLE_INERTIA                         = 0xBADD,
    SMSG_MOVE_ENABLE_INERTIA                          = 0xBADD,
    ...
    SMSG_OPEN_HEART_FORGE = 0xBADD,
    SMSG_OPEN_ANIMA_DIVERSION_UI = 0xBADD,
    SMSG_MULTI_FLOOR_LEAVE_FLOOR = 0xBADD,
    SMSG_MULTI_FLOOR_NEW_FLOOR = 0xBADD,
    SMSG_MOVE_UPDATE_REMOVE_INERTIA = 0xBADD,
    SMSG_MOVE_UPDATE_APPLY_INERTIA = 0xBADD,
    SMSG_MOVE_REMOVE_INERTIA = 0xBADD,
    SMSG_MOVE_APPLY_INERTIA = 0xBADD,
    SMSG_LFG_LIST_APPLICANT_LIST_UPDATE = 0xBADD,
    SMSG_LFG_LIST_APPLICATION_STATUS_UPDATE = 0xBADD,
    SMSG_LFG_LIST_APPLY_TO_GROUP_RESULT = 0xBADD,
    SMSG_LFG_EXPAND_SEARCH_PROMPT = 0xBADD,
    SMSG_LATENCY_REPORT_PING = 0xBADD,
    ...
    SMSG_COVENANT_RENOWN_OPEN_NPC = 0xBADD,
    ...
    SMSG_CLOSE_HEART_FORGE = 0xBADD,
    SMSG_CLEAR_RESURRECT = 0xBADD,
    SMSG_CLAIM_RAF_REWARD_RESPONSE = 0xBADD,
    SMSG_AUCTIONABLE_TOKEN_AUCTION_SOLD = 0xBADD,
    SMSG_AUCTIONABLE_TOKEN_SELL_AT_MARKET_PRICE_RESPONSE = 0xBADD,
    SMSG_AUCTIONABLE_TOKEN_SELL_CONFIRM_REQUIRED = 0xBADD,
    SMSG_APPLY_MOUNT_EQUIPMENT_RESULT = 0xBADD,
    SMSG_ACTIVATE_ESSENCE_FAILED = 0xBADD,
    SMSG_ACTIVATE_SOULBIND_FAILED = 0xBADD,
    SMSG_ACCOUNT_NOTIFICATIONS_RESPONSE = 0xBADD,
